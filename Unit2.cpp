...
//---------------------------------------------------------------------------
void __fastcall TForm2::loadbase()
{
char *errmsg;
sqlite3_stmt *stat;
...
////----------------------------
void __fastcall TForm2::VirtualStringTree1Text(TBaseVirtualTree *Sender, PVirtualNode Node,
...
void __fastcall TForm2::VirtualStringTree1Add(TBaseVirtualTree *Sender,
		  PVirtualNode Node)
{
	sqlite3_stmt *stat;
